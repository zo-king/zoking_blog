      ...
      <>
        ...
        <ContentPanel className="list-workbench">
          ...
          <Table<Post>
            ...
            onRow={(record) =>
              props.canUpdate ? { onClick: () => props.onSelect(record), style: { cursor: "pointer" } } : {}
            }
            columns={[
              {
                title: "文章",
                ...
                render: (_, record) => (
                  <div style={{ minWidth: 0 }}>
                    <Text ellipsis style={{ display: "block" }}>
                      <strong>{record.title || "未命名文章"}</strong>
                    </Text>
      ...
      <PageHeader
        ...
        actions={
          <Space wrap size={4}>
            ...
            <Button
              icon={<IconSave />}
              disabled={!props.canSave || props.writeBlocked}
              loading={props.busy}
            ...
            <Button
              icon={<IconEye />}
              disabled={!props.canPreview || props.writeBlocked}
              loading={props.previewBusy}
            ...
            {props.canPublish && (
              <Button
                type="primary"
                icon={<IconSend />}
                loading={props.busy || props.qualityBusy}
      ...
      <ContentPanel className="editor-workbench">
        <Form<PostFormValues>
          ...
          onValuesChange={(changed) => {
            if (Object.prototype.hasOwnProperty.call(changed, "series_id") && !changed.series_id)
              props.form.setFieldValue("series_order", null);
            props.onFormChange();
          }}
        >
          <Row gutter={[22, 18]} align="stretch">
            ...
            <Col xs={24} xl={7} style={{ minWidth: 0 }}>
              <aside className="editor-sidebar">
                ...
                <Form.Item field="slug" label="Slug" rules={[{ required: true, message: "请输入文章 Slug" }]}>
                ...
                <Form.Item field="category_ids" label="分类">
                  <Select mode="multiple" allowClear placeholder="选择分类" options={props.categoryOptions} />
                </Form.Item>
                <Form.Item field="tag_ids" label="标签">
                  <Select mode="multiple" allowClear placeholder="选择标签" options={props.tagOptions} />
                </Form.Item>
                ...
                <Form.Item field="seo_description" label="搜索摘要">
                  <Input.TextArea rows={3} placeholder="用于搜索结果的页面描述" />
                </Form.Item>
              </aside>
            </Col>
          </Row>
