...
第一次接手项目时，先阅读 [项目介绍与交接手册](project-handover-handbook.md)。它汇总产品边界、代码结构、数据与发布链路、真实生产拓扑、部署、备份、监控、安全和故障处理；专题文档继续负责实现细节。
...
- [项目介绍与交接手册](project-handover-handbook.md)
...
- [P37 技术文章提示块](frontend/article-callouts-p37.md)
...
- [生产备份、恢复与监控](operations/backup-and-monitoring.md)
...
- [P37 技术文章提示块验收](qa/site-article-callout-p37.md)
...
1. [项目介绍与交接手册](project-handover-handbook.md)
2. [上下文接力规则](process/context-handoff.md)
3. [工作日志](process/worklog.md)
4. [当前任务看板与文件锁](process/task-board.md)
5. [工程实施总控手册](plan/engineering-execution-master-plan.md)
6. [Goal 目标计划](plan/goal-plan.md)
7. [系统架构总览](architecture/00-system-overview.md)
8. [需求总览](requirements/00-index.md)
9. [前端工程指导文档](frontend-engineering-guide.md)
