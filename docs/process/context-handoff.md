...
- P37 技术文章提示块证据：`docs/process/evidence/site-p37-article-callouts-desktop-1280x900.png`、`docs/process/evidence/site-p37-article-callouts-mobile-390x844.png`；调研、设计与 QA 为 `docs/references/blog-component-research-p37.md`、`docs/frontend/article-callouts-p37.md`、`docs/qa/site-article-callout-p37.md`。
